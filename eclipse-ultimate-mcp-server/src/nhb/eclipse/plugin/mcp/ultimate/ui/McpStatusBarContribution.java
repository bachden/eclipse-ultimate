 ...
 * Installed from {@link nhb.eclipse.plugin.mcp.ultimate.StartupHook} via
 * {@link #install()}.
 */
public final class McpStatusBarContribution {

    private static final String ITEM_ID = "nhb.eclipse.plugin.mcp.ultimate.statusBarItem";
    ...
    private void showMenu(Control control) {
        ...
        startItem.addListener(SWT.Selection, e -> runCommand("nhb.eclipse.plugin.mcp.ultimate.commands.startServer"));

        MenuItem stopItem = new MenuItem(menu, SWT.PUSH);
        stopItem.setText("Stop Server");
        stopItem.setEnabled(running);
        stopItem.addListener(SWT.Selection, e -> runCommand("nhb.eclipse.plugin.mcp.ultimate.commands.stopServer"));
        ...
        restartItem.addListener(SWT.Selection,
                e -> runCommand("nhb.eclipse.plugin.mcp.ultimate.commands.restartServer"));
        ...
        connectionsItem.addListener(SWT.Selection,
                e -> runCommand("nhb.eclipse.plugin.mcp.ultimate.commands.showConnections"));

        MenuItem settingsItem = new MenuItem(menu, SWT.PUSH);
        settingsItem.setText("Settings...");
        settingsItem.addListener(SWT.Selection,
                e -> runCommand("nhb.eclipse.plugin.mcp.ultimate.commands.openPreferences"));
